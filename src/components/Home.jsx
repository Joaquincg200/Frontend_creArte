...
function Home() {
  ...
  <main style={{ backgroundColor: "#FFFDF6" }}>
    ...
    <div className="container-fluid p-2 position-relative">
      ...
      <div
        className="position-absolute top-50 start-50 translate-middle text-center px-2"
        style={{ width: "90%", maxWidth: "600px" }}
      >
        <h2
          className="fw-bold display-6 display-md-5"
          style={{ color: "#FAF6F0", textShadow: "0 2px 6px rgba(0,0,0,0.4)" }}
        >
          Hecho a mano, diseñado para la vida
        </h2>
        <p
          className="lead mb-3"
          style={{ color: "#000000", textShadow: "0 2px 6px rgba(0,0,0,0.6)" }}
        >
          Descubre productos de alta calidad elaborados por talentosos artesanos de todo el mundo.
        </p>
        <Link
          to={"/shop"}
    ...
    <div className="container p-2 mt-4">
      <h2 className="mb-3">Sugerencias para ti</h2>
    ...
    {lastSearchProduct && relatedProducts.length > 0 && (
      <div className="container p-2 mt-5">
        <h2 className="mb-3">Porque has buscado: {lastSearchProduct.name}</h2>
        <div className="row g-3">
